...
def generate_topic_inferers(src_dir):
    ...
    for l in os.listdir("."):
        ...
        command = "../../libs/mallet/bin/mallet train-topics --input %s --num-topics %s  --output-doc-topics %s.doc.topics  --num-iterations 500 --num-top-words 5 --num-threads 4 --use-ngrams true" % (l, get_topic_count(src_dir, user), user) 
...
def infer_topics_for(src_dir):
    ...
    for l in os.listdir("."):
        ...
        command = "../../libs/mallet/bin/mallet train-topics --input %s --num-topics %s --output-doc-topics %s.test.doc.topics  --num-iterations 500 --num-top-words 5 --num-threads 4 --use-ngrams true" % (l, get_topic_count(src_dir, user), user) 
